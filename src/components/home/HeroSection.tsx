      ...
      <div className="grid gap-10 lg:grid-cols-[2fr_1fr] lg:items-end lg:gap-14">
        ...
        <div>
          ...
          <div className="mt-8 flex items-center gap-5 text-sm">
            <Link
              href="/blog"
              className="text-white underline decoration-white/30 underline-offset-4 transition-colors hover:decoration-white/60">
              글 목록 보기
            </Link>
        ...
        {visitorCount > 0 && (
          <div className="min-w-0">
            <p className="text-sm text-white/45">
              지금까지{" "}
              <span className="font-medium text-white/80">{formatted}명</span>이
              다녀갔어요
            </p>
